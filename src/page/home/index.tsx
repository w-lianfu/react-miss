...
const Home = (props: IProps, state: IState) => {
  ...
  return (
    <DPaper>
      ...
      <DStack>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
        <Button color="primary">你来过</Button>
        <Button color="secondary">一缕烟</Button>
        <Button color="success">过心间</Button>
        <Button color="info">具思念</Button>
        <Button color="warning">忆千年...</Button>
      </DStack>
      <DStack>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
      ...
      <DStack>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
        <Button variant="dashed" color="primary">挫其志</Button>
        <Button variant="dashed" color="secondary">锻其心</Button>
        <Button variant="dashed" color="success">阻其行</Button>
        <Button variant="dashed" color="info">厉其言</Button>
        <Button variant="dashed" color="warning">而屹立不倒...</Button>
      </DStack>
      <DStack>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
      ...
      <DStack>
        <Button variant="contained" color="primary">我不想再前往宫殿了</Button>
        <Button variant="contained" color="secondary">我只愿停留在有你的客栈...</Button>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
        <Button variant="contained" color="info">行行走走忙忙匆匆挤挤</Button>
        <Button variant="contained" color="warning">进进出出影影形形觅觅...</Button>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
        <Button variant="contained" color="error">你是夏天的棉袄</Button>
        <Button variant="outlined" color="primary">沸血, 煮心, 烧脑...</Button>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
        <Button variant="outlined" color="secondary">诗为她而作, 泪为你而流...</Button>
        <Button variant="outlined" color="warning">拿起若有意, 放下又何须用心...</Button>
        <Button variant="outlined" color="error">香烟遇到了火柴, 点亮了自己...</Button>
      </DStack>
      <DStack>
        <Typography variant="body1">------ 可琪, I miss you ------</Typography>
